...
function harbor_widgets_init() {
	...
	register_sidebar(
		array(
			'name'          => __( 'Footer Left', 'harbor' ),
			'description'   => __( 'Widget area for the left footer column.', 'harbor' ),
			'id'            => 'footer-left',
			'before_widget' => '<div class="widget %2$s clearfix">',
			'after_widget'  => '</div>',
	...
	register_sidebar(
		array(
			'name'          => __( 'Footer Middle', 'harbor' ),
			'description'   => __( 'Widget area for the middle footer column.', 'harbor' ),
			'id'            => 'footer-middle',
			'before_widget' => '<div class="widget %2$s clearfix">',
			'after_widget'  => '</div>',
			'before_title'  => '<h4 class="widget-title">',
	...
	register_sidebar(
		array(
			'name'          => __( 'Footer Right', 'harbor' ),
			'description'   => __( 'Widget area for the right footer column.', 'harbor' ),
			'id'            => 'footer-right',
			'before_widget' => '<div class="widget %2$s clearfix">',
			'after_widget'  => '</div>',
			'before_title'  => '<h4 class="widget-title">',
	...
	register_sidebar(
		array(
			'name'          => __( 'Page Bottom', 'harbor' ),
			'description'   => __( 'Widget area for the content at bottom of each page.', 'harbor' ),
			'id'            => 'page-bottom',
			'before_widget' => '<div class="widget %2$s clearfix">',
			'after_widget'  => '</div>',
			'before_title'  => '<h4 class="widget-title">',
...
if ( is_admin() ) {
	...
	require get_theme_file_path( '/inc/meta/meta-courses.php' );
}
